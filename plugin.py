...
#
"""
<plugin key="tinytuya" name="TinyTUYA (Cloud)" author="Xenomes" version="1.2.8" wikilink="" externallink="https://github.com/Xenomes/Domoticz-TinyTUYA-Plugin.git">
    <description>
        ...
        <br/>
        <h2>TinyTUYA Plugin v.1.2.8</h2><br/>
        ...
        for dev in devs:
            ...
            if startup == True:
                ...
                if dev_type == 'light' and createDevice(dev['id'], 1):
                    ...
                    elif searchCode('switch_led', function) and searchCode('work_mode', function) and not (searchCode('colour_data', function) or searchCode('colour_data_v2', function)) and (not searchCode('temp_value', function) or not searchCode('temp_value_v2', function)) and (searchCode('bright_value', function) or searchCode('bright_value_v2', function)):
                ...
                try:
                    ...
                    if dev_type == 'doorbell':
                        if searchCode('basic_indicator', result):
                            ...
                            if int(timestamp) > int(datetimestamp):
                                UpdateDevice(dev['id'], 1, 'On', 1, 0)
